...
def load_model(selected_model):
  if selected_model == 'Mixed':
    return tf.keras.models.load_model("/content/drive/MyDrive/Colab Notebooks/Save/mdlmixed.keras")
  elif selected_model == '40x':
    return tf.keras.models.load_model("/content/drive/MyDrive/Colab Notebooks/Save/mdl40x.keras")
  elif selected_model == '100x':
    return tf.keras.models.load_model("/content/drive/MyDrive/Colab Notebooks/Save/mdl100x.keras")
  elif selected_model == '200x':
    return tf.keras.models.load_model("/content/drive/MyDrive/Colab Notebooks/Save/mdl200x.keras")
  elif selected_model == '400x':
    return tf.keras.models.load_model("/content/drive/MyDrive/Colab Notebooks/Save/mdl400x.keras")
